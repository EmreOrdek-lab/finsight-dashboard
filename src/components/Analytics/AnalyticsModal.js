    ...
    return (
        <section id="analytics" className="enterprise-panel order-5 flex flex-col gap-6 overflow-hidden bg-slate-900/50 p-6 shadow-xl sm:w-10/12 sm:m-auto md:w-9/12 xl:col-span-12 xl:w-full">
            <div className="flex items-center justify-between gap-3">
                <h2 className="basis-7/12 text-xl font-semibold text-slate-900 dark:text-slate-100">Analytics</h2>
                <h3 className="hidden text-lg font-semibold text-slate-900 dark:text-slate-100 xl:inline">Trends</h3>
            </div>
            <div className="flex flex-col gap-8 xl:grid xl:grid-cols-2 xl:items-start xl:px-2"> 
                <div className="min-w-0 flex flex-col gap-5">
                    <section className="xl:grid xl:grid-cols-[120px_minmax(0,1fr)] xl:items-start xl:gap-6">
                        <h4 className="text-slate-900 dark:text-slate-100">Cashflow</h4>
                        <div className="min-w-0 xl:flex xl:flex-col xl:gap-4">
                            ...
                            <div className="flex flex-wrap justify-center gap-3 items-center xl:justify-start xl:gap-8">
                                <div className="flex flex-col justify-center items-center">
                                    <h5 className="text-lg text-slate-900 dark:text-slate-100">{income - expenses > 0 ? 'Pos. Cashflow' : 'Neg. Cashflow'}</h5>
                                ...
                                <div>
                                    <h5 className="text-lg text-slate-900 dark:text-slate-100">{income - expenses > 0 ? '% Unspent' : '% Overspent'}</h5>
                    ...
                    <section className="xl:grid xl:grid-cols-[120px_minmax(0,1fr)] xl:items-start xl:gap-6">
                        <h4 className="text-slate-900 dark:text-slate-100">Net Worth</h4>
                        <div className="mx-auto flex flex-col items-center justify-center gap-2 text-center xl:w-full xl:max-w-md">
                            <div className='flex flex-col'>
                                <h5 className="text-lg text-slate-900 dark:text-slate-100">Debit Accs. Total</h5>
                            ...
                            <div className="flex flex-col">
                                <h5 className="text-lg text-slate-900 dark:text-slate-100">Savings</h5>
                            ...
                            <div className="text-slate-900 dark:text-slate-100">-</div>
                            <div className="flex flex-col">
                                <h5 className="text-lg text-slate-900 dark:text-slate-100">Credit Cards Total</h5>
                            ...
                            <div className="flex flex-col gap-1 text-center">
                                ...
                                <h5 className="text-lg text-slate-900 dark:text-slate-100">Total</h5>
                            </div>
                        </div>
                    </section>
                </div>
                <div className="flex w-full min-w-0 flex-col gap-4">
                    <figure className="enterprise-stat-card h-[300px] overflow-hidden p-4">
                        {(transactions && Object.keys(transactions).length > 0) ?
                            ...
                            :
                            <div className="text-slate-600 dark:text-zinc-400">Create Transactions to see your Spending Trends</div> 
                        }
                    </figure>
